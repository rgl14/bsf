...
export class MatchlistComponent implements OnInit {
  ...
  constructor() { 
    ...
    this.gridOptions.rowData = [
      { isactive:1,matchname:'Ireland v Netherlands',tourname:'ICC World T20 Qualifiers',status:'OPEN',matchdate:'2019-11-01 15:40:00',id: '1' },
      { isactive:1,matchname:'Papua New Guinea v Namibia',tourname:'ICC World T20 Qualifiers',status:'OPEN',matchdate:'2019-11-01 21:00:00',id: '2' },
     ];
