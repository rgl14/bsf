...
export class DeclaredfancybetslipComponent implements OnInit {
  ...
  constructor(private route:ActivatedRoute,private reports:ReportsService) {
    ...
    this.gridOptions.columnDefs = [
      ...
      {headerName: 'Bet type', field: 'betType', sortable: true, minWidth: 75,cellStyle: {color: '#414141','font-weight':'bolder'},cellClass: function(params) { return (params.value == 'Yes' ? 'Back':'Lay')}},
      ...
      {headerName: 'P | L', field: '', sortable: true, minWidth: 100,valueFormatter: profitlossFormatter,cellStyle:cellstlesetter },
