...
export class DeclaredbetslipComponent implements OnInit {
  ...
  constructor(private route:ActivatedRoute,private reports:ReportsService) {
    ...
    this.gridOptions.columnDefs = [
      ...
      {headerName: 'Runner', field: 'runnerName', sortable: true, minWidth: 100,cellStyle: {color: '#414141','font-weight':'bolder'}},
      {headerName: 'Bet type', field: 'betType', sortable: true, minWidth: 75,cellStyle: {color: '#414141','font-weight':'bolder'},cellClass: function(params) { return (params.value == 'Back' ? 'Back':'Lay')}},
      {headerName: 'Client', field: 'client', sortable: true, minWidth: 100,cellStyle: {color: '#414141','font-weight':'bolder'}},
      {headerName: 'Odds', field: 'odds', sortable: true, minWidth: 75},
      {headerName: 'Stake', field: 'stake', sortable: true, minWidth: 75,valueFormatter: balanceFormatter},
      {headerName: 'P | L', field: 'MComm', sortable: true, minWidth: 100,valueFormatter: profitlossFormatter,cellStyle: cellstlesetter},
      {headerName: 'Time', field: 'betTime', sortable: true, minWidth: 125,cellStyle: {color: 'red','font-weight':'bolder'}},
      ...
      {headerName: 'Status', field: 'action', sortable: true, minWidth: 75,cellStyle: {'font-weight':'bolder'},cellClass: function(params) { return (params.value == 'WIN' ? 'profit':'loss')}},
    ]; 
