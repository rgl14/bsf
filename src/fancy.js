...
var favoriteCookie = $.cookie("AuthToken");
...
function FancyBets() {
    ...
    $.ajax({
        url: 'http://173.249.21.26/P7xAdmin/P7xAdmin.svc/FancyRates/FancyBets?id=' + FID,
        method: 'GET',
        async: true,
        crossDomain: true,
        headers: {
...
function RejectBetsMulti() {
    ...
    $.ajax({
        url: 'http://173.249.21.26/P7xAdmin/P7xAdmin.svc/FancyRates/RejectBetsMulti?ids=' + ids + '&mtid=' + mtid + '&pwd=' + pass,
        method: 'POST',
        crossDomain: true,
        async: true,
        headers: {
...
function RejectFancyBets() {
    ...
    var pass = "1" + inputpass + "9";
    $.ajax({
        url: 'http://173.249.21.26/P7xAdmin/P7xAdmin.svc/FancyRates/RejectFancyBets?id=' + id + '&pwd=' + pass,
        method: 'POST',
        crossDomain: true,
        async: true,
        headers: {
...
function GetFancyInfobyId() {
    $.ajax({
        url: 'http://173.249.43.228/BSF777Adm/Admin.svc/Fancy/GetFancyInfobyId?id=' + urlFid,
        method: 'GET',
        headers: {
            "Token": favoriteCookie
        },
...
function SaveKeyShortcuts() {
    ...
    $.ajax({
        url: 'http://173.249.43.228/BSF777Adm/Admin.svc/Settings/SaveKeyShortcuts',
        method: 'POST',
        crossDomain: true,
        async: true,
        data: finaldata,
...
function GetKeyShortcuts() {
    ...
    $.ajax({
        url: 'http://173.249.43.228/BSF777Adm/Admin.svc/Settings/GetKeyShortcuts',
        method: 'GET',
        async: true,
        crossDomain: true,
        headers: {
        ...
        bootbox.confirm("Current score update has bigger change than previous score (" + Previousfnacyratevalue + ") and rate Range defined (" + rateMinus + "-" + ratePlus + ") ?",
            function (result) {
                if (result == true) {
                    ...
                    var finaldata = JSON.stringify(data);
                    $.ajax({
                        url: 'http://173.249.43.228/BSF777Adm/Admin.svc/FancyRates/UpdateFancyRate',
                        method: 'POST',
                        crossDomain: true,
                        async: true,
                        data: finaldata,
...
function UpdFancySettings() {
    ...
    $.ajax({
        url: 'http://173.249.43.228/BSF777Adm/Admin.svc/Fancy/UpdFancySettings',
        method: 'POST',
        crossDomain: true,
        async: true,
        data: finaldata,
...
function UpdBetStatus(status) {
    ...
    $.ajax({
        url: 'http://173.249.43.228/BSF777Adm/Admin.svc/FancyRates/UpdBetStatus?id=' + F_ID + '&status=' + status,
        method: 'POST',
        crossDomain: true,
        async: true,
        headers: {
...
function UpdateBallStatus(status) {
    ...
    $.ajax({
        url: 'http://173.249.43.228/BSF777Adm/Admin.svc/FancyRates/UpdateBallStatus?id=' + F_ID + '&status=' + status,
        method: 'POST',
        crossDomain: true,
        async: true,
        headers: {
...
function LastBallStatus() {
    var F_ID = $("#Fancyid").val();
    $.ajax({
        url: 'http://173.249.43.228/BSF777Adm/Admin.svc/FancyRates/LastBallStatus?id=' + F_ID,
        method: 'GET',
        async: true,
        crossDomain: true,
        headers: {
...
function UpdateFancyRateStatus(staus) {
    var F_ID = $("#Fancyid").val();
    $.ajax({
        url: 'http://173.249.43.228/BSF777Adm/Admin.svc/Fancy/UpdateFancyStatus?id=' + F_ID + '&status=' + staus,
        method: 'POST',
        crossDomain: true,
        async: true,
        headers: {
...
function UpdateFancyBetStatus(status) {
    var F_ID = $("#Fancyid").val();
    $.ajax({
        url: 'http://173.249.43.228/BSF777Adm/Admin.svc/Fancy/UpdateFancyBetStatus?id=' + F_ID + '&status=' + status,
        method: 'POST',
        crossDomain: true,
        async: true,
        headers: {
...
function UpdateFancyCommStatus(status) {
    var F_ID = $("#Fancyid").val();
    $.ajax({
        url: 'http://173.249.21.26/P7xAdmin/P7xAdmin.svc/DataManagement/UpdateFancyCommStatus?id=' + F_ID + '&status=' + status,
        method: 'POST',
        crossDomain: true,
        async: true,
        headers: {
