...
myapp.controller("Booksettingcontroller", function (
  ...
  var favoriteCookie = $cookies.get("AuthToken");
  ...
  $scope.GetBookInfo = function () {
    ...
    $http({
      method: "GET",
      url:
        "http://173.249.43.228/BSF777Adm/Admin.svc/BookMaking/GetBookInfo?id=" +
        $scope.bookid,
      headers: {
  ...
  $scope.EditBookSettings = function () {
    ...
    $http({
      method: "POST",
      url:
        "http://173.249.43.228/BSF777Adm/Admin.svc/BookMaking/EditBookSettings",
      headers: {
        Token: favoriteCookie
      },
      data: finaldata
  ...
  $scope.EditBetStatus = function (fstatus) {
    ...
    $http({
      method: "POST",
      url:
        "http://173.249.43.228/BSF777Adm/Admin.svc/BookMaking/EditBetStatus?id=" +
        $scope.bookid +
        "&status=" +
        fstatus,
      headers: {
  ...
  $scope.EditBookStatus = function (val) {
    ...
    $http({
      method: "POST",
      url:
        "http://173.249.43.228/BSF777Adm/Admin.svc/BookRates/EditBookStatus?id=" +
        $scope.bookid +
        "&status=" +
        val,
      headers: {
  ...
  $scope.UpdRunnerStatus = function (id, val, isbothback) {
    ...
    $http({
      method: "POST",
      url:
        "http://173.249.43.228/BSF777Adm/Admin.svc/BookRates/UpdRunnerStatus?id=" +
        $scope.bkid +
        "&status=" +
        val +
        "&both=" +
  ...
  $scope.BookRate = function (runnerid, type) {
    ...
    $http({
      method: "POST",
      url: "http://173.249.43.228/BSF777Adm/Admin.svc/BookRates/UpdBookRate",
      headers: {
        Token: favoriteCookie
      },
      data: bookdata
  ...
  $scope.BookBets = function () {
    ...
    $http({
      method: "GET",
      url:
        "http://173.249.43.228/BSF777Adm/Admin.svc/BookMaking/BookBets?id=" +
        $scope.bookid +
        "&mtid=" +
        $scope.eventId,
      headers: {
  ...
  $scope.bmBetsSignalr = function () {
    $scope.bmBetConnection = $.hubConnection("http://167.86.74.159:4135");
  ...
  $scope.RejectBetsMulti = function () {
    ...
    $http({
      method: "POST",
      url:
        "http://173.249.43.228/BSF777Adm/Admin.svc/FancyRates/RejectBetsMulti?ids=" +
        ids +
        "&mtid=" +
        $scope.eventId +
        "&pwd=1" +
      ...
      callback: function (result) {
        ...
        if (result == true) {
          ...
          $http({
            method: "POST",
            url:
              "http://173.249.43.228/BSF777Adm/Admin.svc/FancyRates/RejectFancyBets?id=" +
              betId +
              "&pwd=1" +
